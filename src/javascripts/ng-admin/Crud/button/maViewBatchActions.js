export default function maViewBatchActionsDirective() {
    return {
        ...
        template:
`<span ng-if="selection" ng-class="{hidden:!selection || selection.length==0}"> <span class="btn-group" uib-dropdown is-open="isopen"><button type="button" data-testid="batch-actions-toggle" ng-if="selection.length" class="btn btn-default dropdown-toggle" uib-dropdown-toggle >
